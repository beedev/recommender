...
JWT token management, password security, and authentication workflows.
...
from ..models.user_auth import User, RefreshToken, UserRole
import logging
...
class AuthService:
    ...
    async def revoke_all_user_tokens(self, user_id: str, session: AsyncSession) -> int:
        """
