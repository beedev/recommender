...
Bharath's Quality-First Implementation providing comprehensive
JWT validation, user context, and permission management.
...
from ..models.user_auth import User, UserRole
from ..database.sqlalchemy_config import get_postgres_session
import logging
...
class AuthMiddleware:
    ...
    def require_admin(self, current_user: User = Depends(lambda: auth_middleware.get_current_user)) -> User:
        """
