/**
 * ESAB Design System - Design Tokens
 * 
 * Centralized design tokens for consistent styling across the application.
 * These tokens are used by both CSS custom properties and TypeScript components.
 */
...
export const colors = {
  ...
  // Primary Color Scale (based on ESAB gold)
  primary: {
    50: '#FEF7E0',
    100: '#FDECC8',
    200: '#FBD88D',
...
export const boxShadow = {
  ...
  'esab-xl': '0 20px 25px -5px rgba(139, 69, 19, 0.1), 0 8px 10px -6px rgba(139, 69, 19, 0.05)',
} as const
...
export const componentVariants = {
  button: {
    ...
    variant: {
      ...
      secondary: 'bg-neutral-600 hover:bg-neutral-700 focus:ring-neutral-500 text-white',
